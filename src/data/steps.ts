...
export function buildSteps(rounds: Round[]): StepDef[] {
  ...
  steps.push({
    ...
    body: [
      'Denne guiden tar deg gjennom hele RO RO RO-bøttehatten, én runde av gangen — Helene Spillings 4,0 mm-oppskrift, laget for deg som aldri har heklet før.',
      'Hatten i 3D vokser etter hvert som du fullfører rundene. Åpne Maskeskolen for animasjoner du kan spille av så mange ganger du vil.',
  ...
  steps.push({
    ...
    eyebrow: 'Før du begynner',
    body: [
      'Når du begynner, har du to tråder: Arbeidstråden er den lange tråden som går til garnnøstet — det er denne du hekler med. Garnhalen er den korte løse enden ved startknuten — den bruker du ikke til å lage masker.',
      'Den viktigste regelen: Løkken som sitter på heklenålen er IKKE en maske.',
      'Når du teller masker, teller du de små V-formene i selve arbeidet. Du teller aldri løkken på nålen, aldri luftmasken som starter en runde, og aldri kjedemasken som lukker den.',
    ],
    yarn: null,
    countChip: null,
  ...
  steps.push({
    ...
    eyebrow: 'Trening',
    body: [
      'Før du begynner på hatten: lag en løpeknute, lag 10 luftmasker, og hekle fastmasker tilbake langs luftmaskene. Lag gjerne to eller tre rette rader.',
      'Det gjør ingenting om øvingsbiten blir skjev. Dra den opp igjen når bevegelsen begynner å gi mening.',
      'Du er klar til å starte hatten når du kan lage en fastmaske og forstår hvorfor du først får to løkker på nålen og deretter én.',
      'Bruk animasjonene i Maskeskolen — de viser nøyaktig samme bevegelser.',
      'Pga. rettigheter på videoer er det ikke linket til videoer som demonstrerer teknikkene. Dette kan du enkelt søke opp på YouTube, Instagram, TikTok osv. Prøv f.eks. «løpeknute hekling», «luftmasker nybegynner» og «fastmaske hekling».',
    ],
    yarn: 'white',
    countChip: null,
