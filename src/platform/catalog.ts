...
export const CATALOG: CatalogEntry[] = [
  ...
  },
  {
    ...
    collection: 'norway26',
    difficulty: 'enkel',
    desc: 'Svart bunn med seks brede grå strøk i skifer og stein over pull, side og brem. Hvitt er forbeholdt skriften og kanten: NORGE i hvit kursiv foran og bak, og to hvite kantrunder nederst. Kolleksjonens enkleste gest.',
    colors: ['black', 'white', 'slate', 'stone'],
    hook: '4,0 mm',
    time: '5–7 t',
    tag: 'NY',
  },
