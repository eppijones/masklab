...
export const CATALOG: CatalogEntry[] = [
  ...
  },
  {
    ...
    collection: 'norway26',
    difficulty: 'enkel',
    desc: 'Svart bunn med seks brede grå strøk over pull, side og brem. Rent hvitt er forbeholdt skriften og kanten: NORGE i hvit kursiv foran og bak, og to hvite kantrunder nederst. Tre garn i alt — kolleksjonens enkleste hatt.',
