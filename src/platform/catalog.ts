...
export const CATALOG: CatalogEntry[] = [
  ...
  },
  {
    ...
    collection: 'norway26',
    difficulty: 'avansert',
    desc: 'Draktmønsteret som hekling: tette striper i rødt, hvitt og lyseblått over marineblå bunn, jevnt fordelt hele veien rundt — NORGE i stigende runisk kursiv foran og bak. Mønsteret går ubrutt helt ut i bremmen, med to hvite kantrunder nederst.',
  ...
  },
  {
    ...
    collection: 'norway26',
    difficulty: 'middels',
    desc: 'Hvit bunn med marineblå og lyseblå striper fra pullen og helt ned — NORGE i stigende runisk kursiv marineblått foran og bak, og to røde kantrunder nederst.',
  ...
  },
  {
    ...
    collection: 'norway26',
    difficulty: 'enkel',
    desc: 'Svart bunn med hvite striper over pull, side og brem — NORGE i stigende hvit runisk kursiv foran og bak, og to hvite kantrunder nederst. Kolleksjonens enkleste.',
    colors: ['black', 'white'],
    hook: '4,0 mm',
    time: '5–7 t',
    tag: 'NY',
  ...
  },
  {
    ...
    collection: 'norway26',
    difficulty: 'avansert',
    desc: 'Keeperdrakten: sterk gul med tette sikksakk-striper i mørkere gult, oransje og rosa — bare varme farger, ingen grå. NORGE i stigende svart runisk kursiv, og to svarte kantrunder nederst.',
