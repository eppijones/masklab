...
export const BOM: readonly BomLine[] = [
  ...
  },
  {
    ...
    checkedAt: D,
    usedInFull: true,
    note: 'Wheel hub, dancer pivot and one per yarn spinner. The cheapest precision object in any hardware shop, and the reason the spinner subsystem costs almost nothing.',
  },
  {
    id: 'leadscrew-t8',
  ...
  },
  {
    ...
    tracks: ['bench', 'full'],
    vendor: '3DJake Norge',
    url: 'https://www.3djake.no/search?query=termistor',
    priceNok: 69,
    verified: false,
    inStock: null,
    checkedAt: D,
  ...
  {
    id: 'nuts-m3m4',
    item: 'M3 + M4 hex nuts and nylocs, assorted',
    itemNo: 'M3 + M4 muttere og låsemuttere',
    qty: 1,
    unit: 'sett',
    group: 'fasteners',
    tracks: ['bench', 'full'],
    ...
    checkedAt: D,
    usedInFull: true,
    substituteFor: 'Heat-set brass inserts — deleted from the design outright',
    note: 'These replaced the brass inserts, and with them the soldering iron, the 240 C, the fumes and the crooked-insert failure mode. Every threaded hole in a printed part is now a nut dropped into a side-entry pocket. A nut is also a thing any hardware shop in Norway has on a shelf. TO VERIFY.',
  },
  {
    id: 'screws-m5',
  ...
  /* --------------------------------------------------------- yarn/needle -- */
  {
    ...
    tracks: ['bench', 'full'],
    vendor: '3DJake Norge',
    url: 'https://www.3djake.no/filamenter',
    priceNok: 49,
    verified: false,
    inStock: null,
    checkedAt: D,
    usedInFull: true,
    note: 'One per yarn spinner guide arm plus the feed path. Cotton abrades a printed guide into a groove within a few hundred stitches, and a groove is a feed path that tightens without anyone noticing. TO VERIFY.',
    substituteFor: '3dprintnorge.net — the domain no longer resolves',
  },
  {
    id: 'yarn',
    ...
    tracks: ['bench', 'full'],
    vendor: 'Hobbii',
    url: 'https://www.hobbii.no/garn',
    priceNok: 59,
    verified: false,
    inStock: null,
    checkedAt: D,
    usedInFull: true,
    note: 'Use the SAME yarn the finished hats use. Testing on acrylic proves nothing — how cotton behaves against a printed throat is the entire question G0 asks. TO VERIFY the exact weight.',
    substituteFor: 'hobbygross.no — the domain no longer resolves',
  },
  ...
  /* -------------------------------------------------------- consumables --- */
  {
    ...
    tracks: ['bench', 'full'],
    vendor: '3DJake Norge',
    url: 'https://www.3djake.no/filament/petg',
    priceNok: 279,
    verified: false,
    inStock: null,
    checkedAt: D,
  ...
  },
  {
    ...
    tracks: ['bench', 'full'],
    vendor: '3DJake Norge',
    url: 'https://www.3djake.no/filament/pla',
    priceNok: 229,
    verified: false,
    inStock: null,
    checkedAt: D,
